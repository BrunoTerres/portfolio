...
class NgoCreate(CreateView):
    model = Ngo
    fields = ['name', 'email', 'description', 'DDD', 'whatsapp', 'city', 'ur']

class NgoUpdate(UpdateView):
    model = Ngo
    fields = ['name', 'email', 'description', 'DDD', 'whatsapp', 'city', 'ur']  # '__all__'  Not recomended (Potential security issue if more fields added)
